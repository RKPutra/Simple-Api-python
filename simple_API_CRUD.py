...
class UserReview(Resource):
    def post(self):
        try:
            ...
            parser.add_argument('order_id', type=int, help="order_id cannot be blank!")
            parser.add_argument('product_id', type=int, help="product_id cannot be blank!")
            parser.add_argument('user_id', type=int, help="user_id cannot be blank!")
            parser.add_argument('rating', type=float, help="rating cannot be blank!")
            parser.add_argument('review', type=str, help="review cannot be blank!")
